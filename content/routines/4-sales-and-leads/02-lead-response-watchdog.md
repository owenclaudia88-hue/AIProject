...
2. Paste the instructions and **set your thresholds at the bottom**
3. **Schedule** → **Daily**, then `/schedule update` in the CLI to set `0 10,14,18 * * *`
4. **Connectors**: Gmail
5. **Create**, then **Run now** — the first run usually finds something uncomfortable
