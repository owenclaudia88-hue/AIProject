...
2. Paste the instructions and **tell it where your documentation is at the bottom**
3. **Schedule** → **Weekly** → Friday, 16:00
4. **Connectors**: Gmail. Add Google Drive if you keep your documentation there
5. **Environment**: **Full** or **Custom** with your own domain, so it can check whether your site already answers something
6. **Create**
...
Questions we have already answered this quarter:
```
