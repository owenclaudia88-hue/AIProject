...
3. **Schedule** → **Daily**, then `/schedule update` in the CLI to set `0 7 * * 1-5` if you want weekdays only
4. **Connectors**: Gmail and Google Calendar. Add Stripe if you sell, Slack if your team lives there
5. **Create**, then **Run now** so you can see the shape of it
