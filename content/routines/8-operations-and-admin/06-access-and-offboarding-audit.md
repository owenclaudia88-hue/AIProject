...
2. Paste the instructions and **list your people, your systems and your leavers at the bottom**
3. **Schedule** → **Monthly** → 1st, 09:00
4. **Connectors**: Gmail and Google Drive
5. **Create**
...
Current people, with their company email addresses:
Leavers and finished contractors — name, every address they used, and
when they left:
Systems we use — name each one:
Drive folders to check sharing on:
