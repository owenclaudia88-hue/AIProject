...
Ignore emails from these addresses or domains: [e.g. @yourcompany.com,
  your suppliers, your accountant]
Ignore emails in these folders or with these labels: [e.g. label:Receipts,
  label:Newsletters, Spam]
Slack channels to read, if connected: [e.g. #support, #customers — leave
  blank if you do not use Slack]
```
