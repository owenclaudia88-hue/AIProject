...
2. **New routine**, name it `Newsletter First Draft`
3. Paste the instructions and **fill in the bottom section**
4. **Schedule** → **Weekly** → Wednesday, 08:00
...
Who reads it:
What I want them to feel at the end:
Words and phrases I would never use:
Two real subject lines of mine that did well:
```
