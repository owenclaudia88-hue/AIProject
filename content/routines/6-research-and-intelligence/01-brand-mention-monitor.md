...
2. Paste the instructions and **put your name and your places at the bottom**
3. **Schedule** → **Daily** → 08:00
4. **Connectors**: none. Remove them all — this reads public pages and needs access to nothing of yours
5. **Environment**: the default blocks most outbound traffic. Edit it to **Full**, or **Custom** with the domains you listed. Without this it finds nothing and looks broken
6. **Create**
