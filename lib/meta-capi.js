...
/**
 * Somebody handed over a name and an email.
 *
 * Fires at the same moment as InitiateCheckout, because on this checkout they
 * are the same moment — the first step asks for a name and email and nothing
 * else. Kept as a separate event so a campaign can optimise for leads without
 * being tied to the purchase funnel, and so InitiateCheckout keeps meaning
 * what it already means to the campaign running against it.
 *
